...
const Footer = () => {
  return (
    <footer className='bg-[#66371e] text-white p-2'>
      ...
      {/* div for desktop and tablet design */}
      <div className='hidden sm:block'>
        <div className='flex justify-around'>
          <div className='p-1 sm:p-4'>
            <h1 className='text-base sm:text-lg font-bold text-[#341c10]'>About Us</h1>
            <form className='w-96'>
              <label htmlFor='email-footer'>Welcome to our website, a wonderful place to explore and learn how to cook like a pro.</label>
              <input 
                id='email-footer'
